...
class PurchaseInvoice(BuyingController):
	...
	def on_submit(self):
		...
		# Custom: Auto-create credit note if custom_is_credit_note is checked
		if getattr(self, "custom_is_credit_note", False) and not self.is_return:
			from erpnext.accounts.doctype.purchase_invoice.purchase_invoice import make_debit_note
			credit_note = make_debit_note(self.name)
			# Optionally, you can save/submit the credit note here if needed
			# credit_note.submit()  # Uncomment if you want to auto-submit
